...
<?php
	...
	function enregistrer ($n, $p, $num, $mail, $mdp1, $genre, $voie, $adr, $cadr, $cp){
		...
		$sql = "INSERT INTO utilisateur(nom, prénom, tel, email, motdepasse, sexe, num_voie, nom_voie, complement_adr, code_postal) VALUES ('$n', '$p', '$num', '$mail', '$mdp1', '$genre', '$voie', '$adr', '$cadr', '$cp')";
